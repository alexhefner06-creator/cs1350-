...
overall_average = round(grand_total / len(total_minutes), 2)
print(f"Total minutes: {grand_total}")
print(f"Average per contact: {overall_average:.2f}")
 
print("--- Above Average Contacts ---")
for name, minutes in total_minutes.items():
    if minutes > overall_average:
...
print("-" * 57)
print(f"{len(total_minutes)} contacts | {grand_total} total minutes | {overall_average:.2f} average")